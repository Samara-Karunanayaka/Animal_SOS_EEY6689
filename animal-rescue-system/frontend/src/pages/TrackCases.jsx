      ...
      setCases([
        {
          ...
          animal: 'Dog',
          breed: 'Labrador Mix',
          location: 'Diyatha Uyana, Colombo',
          status: 'In Progress',
          priority: 'High',
          time: '10 minutes ago',
          volunteer: 'J.V.Silva',
          ...
          updates: [
            ...
            { time: '5 min ago', text: 'Case assigned to John Silva' },
          ],
        },
        {
          id: 2,
        ...
        },
        {
          ...
          location: 'Colombo North District',
          status: 'Reported',
          priority: 'High',
          time: '5 minutes ago',
