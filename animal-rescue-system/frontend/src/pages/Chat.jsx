...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    setMessages({
      1: [
        { id: 1, sender: 'Amal (Volunteer)', text: 'I received your rescue request', time: '10:30 AM', isMe: false },
        { id: 2, sender: 'You', text: 'Thank you! The dog is near the park entrance', time: '10:32 AM', isMe: true },
        { id: 3, sender: 'Amal (Volunteer)', text: "I'm on my way. ETA 10 minutes", time: '10:35 AM', isMe: false },
        { id: 4, sender: 'Amal (Volunteer)', text: 'Can you describe the dog?', time: '10:36 AM', isMe: false },
      ],
      2: [
      ...
      3: [
        { id: 1, sender: 'Dr. Sarath (Vet)', text: 'The dog is responding well to treatment', time: '2:00 PM', isMe: false },
        { id: 2, sender: 'You', text: 'Thats great news! When can we visit?', time: '2:05 PM', isMe: true },
        { id: 3, sender: 'Dr. Sarath (Vet)', text: 'Tomorrow afternoon would be fine', time: '2:10 PM', isMe: false },
      ],
    });
  }, []);
