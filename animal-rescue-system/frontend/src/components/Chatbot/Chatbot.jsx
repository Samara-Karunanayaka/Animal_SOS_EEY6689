...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "🐾 Hello! I'm your AI Animal Rescue Assistant. How can I help you with animal rescue, adoption, or welfare today?",
      sender: 'bot',
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:5282/api/chatbot/chat', {
      ...
      const errorMessage = {
        id: messages.length + 2,
        text: `Sorry, I'm having trouble connecting right now. Error: ${errorMsg}. Please check your API key and try again.`,
        sender: 'bot',
        timestamp: new Date().toLocaleTimeString(),
      };
