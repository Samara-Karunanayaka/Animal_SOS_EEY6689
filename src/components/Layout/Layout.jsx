            ...
            <Grid item xs={12} md={4}>
              ...
              <Box sx={{ color: 'rgba(255,255,255,0.7)' }}>
                <Box display="flex" alignItems="center" gap={1} mb={1}>
                  ...
                  <Typography variant="body2">123 Rescue Street, Animal City, AC 12345</Typography>
                </Box>
                <Box display="flex" alignItems="center" gap={1} mb={1}>
                ...
                <Box display="flex" alignItems="center" gap={1} mb={1}>
                  ...
                  <Typography variant="body2">info@animalrescue.org</Typography>
                </Box>
                <Box display="flex" alignItems="center" gap={1}>
                  <InfoIcon fontSize="small" sx={{ color: '#FF6B6B' }} />
                  <Typography variant="body2">24/7 Emergency: +1 (234) 567-899</Typography>
                </Box>
              </Box>
            </Grid>
          </Grid>
