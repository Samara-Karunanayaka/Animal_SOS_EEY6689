...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      setPendingApprovals([
        { id: 1, type: 'NGO', name: 'Animal Care Foundation', email: 'contact@animalcare.org', date: '2024-03-10', documents: true },
        { id: 2, type: 'Volunteer', name: 'Sarah Johnson', email: 'sarah.j@email.com', date: '2024-03-09', documents: true },
        { id: 3, type: 'NGO', name: 'Paws Rescue Team', email: 'info@pawsrescue.org', date: '2024-03-08', documents: false },
        { id: 4, type: 'Volunteer', name: 'Mike Thompson', email: 'mike.t@email.com', date: '2024-03-07', documents: true },
      ]);

      setRecentActivities([
        { id: 1, action: 'New NGO registered', user: 'Happy Paws Foundation', time: '10 min ago', type: 'registration' },
        { id: 2, action: 'Report submitted', user: 'Central Park', time: '25 min ago', type: 'report' },
      ...
      setUsers([
        { id: 1, name: 'John Doe', role: 'Volunteer', status: 'Active', reports: 23, joined: 'Jan 2024' },
        { id: 2, name: 'Animal Care NGO', role: 'NGO', status: 'Pending', reports: 45, joined: 'Feb 2024' },
        { id: 3, name: 'Jane Smith', role: 'Volunteer', status: 'Active', reports: 67, joined: 'Dec 2023' },
        { id: 4, name: 'Paws Rescue', role: 'NGO', status: 'Suspended', reports: 12, joined: 'Mar 2024' },
      ]);
