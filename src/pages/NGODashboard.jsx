...
const NGODashboard = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      setActiveVolunteers([
        { id: 1, name: 'Mike Johnson', tasks: 3, status: 'Available', rating: 4.8 },
        { id: 2, name: 'Emily Brown', tasks: 2, status: 'Busy', rating: 4.9 },
        { id: 3, name: 'David Wilson', tasks: 1, status: 'Available', rating: 4.7 },
        { id: 4, name: 'Lisa Anderson', tasks: 4, status: 'Busy', rating: 4.8 },
      ]);
