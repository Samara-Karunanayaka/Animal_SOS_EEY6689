...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setRecentCases([
        { id: 1, animal: 'Dog', location: 'Central Park', status: 'In Progress', priority: 'High', time: '10 min ago' },
        { id: 2, animal: 'Cat', location: 'Downtown', status: 'Assigned', priority: 'Medium', time: '25 min ago' },
        { id: 3, animal: 'Bird', location: 'Riverside', status: 'Resolved', priority: 'Low', time: '1 hour ago' },
        { id: 4, animal: 'Rabbit', location: 'North Park', status: 'Reported', priority: 'High', time: '5 min ago' },
      ]);
          ...
          <Paper sx={{ p: 3 }}>
            ...
            <List>
              <ListItem sx={{ px: 0 }}>
                ...
                <ListItemText primary="John Doe" secondary="45 rescues this month" />
              </ListItem>
              <ListItem sx={{ px: 0 }}>
                <ListItemAvatar>
                  <Avatar sx={{ bgcolor: '#C0C0C0' }}>2</Avatar>
                </ListItemAvatar>
                <ListItemText primary="Jane Smith" secondary="38 rescues this month" />
              </ListItem>
              <ListItem sx={{ px: 0 }}>
                <ListItemAvatar>
                  <Avatar sx={{ bgcolor: '#CD7F32' }}>3</Avatar>
                </ListItemAvatar>
                <ListItemText primary="Mike Johnson" secondary="32 rescues this month" />
              </ListItem>
            </List>
          </Paper>
        </Grid>
